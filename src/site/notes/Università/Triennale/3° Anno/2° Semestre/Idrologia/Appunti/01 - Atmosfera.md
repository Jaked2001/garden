---
{"dg-publish":true,"permalink":"/universita/triennale/3-anno/2-semestre/idrologia/appunti/01-atmosfera/","dg-note-properties":{"aliases":["1 - Atmosfera","Atmosfera"],"Materia":"Idro","Tipo":"T","Stato":"🟢 Fatto","Slide":["[1. Atmosfera - Idro.pdf](/img/user/Universit%C3%A0/Triennale/3%C2%B0%20Anno/2%C2%B0%20Semestre/Idrologia/Appunti/allegati/1.%20Atmosfera%20-%20Idro.pdf)"],"PDF":null,"Parents":["[[💧 Idrologia]]"]}}
---
...
Essendo la superficie terrestre riscaldata per irraggiamento, emette a sua volta energia radiante. Il suo spettro è mediamente quello di un corpo alla temperatura di $287\,\rm k$.
...
```ad-Definizione
title: Stratosfera
La **Stratosfera** è lo strato immediatamente sovrastante la [[Troposfera\|Troposfera]].
```
...
La **mesosfera** è lo strato al di sopra della [[Stratosfera\|Stratosfera]]. È caratterizzata dalla presenza di [[Ozono]], generato dalla radiazione solare nella banda ultravioletta

```

L'ozono assorbe le radiazioni ultraviolette dell'irraggiamento solare, per cui la mesosfera è riscaldata essenzialmente dall'alto. Per questo motivo la sua temperatura va crescendo dall'alto verso il basso, fino al cosiddetto [[strato caldo\|strato caldo]] e diminuisce dopo di esso.
...
La termosfera è lo strato sopra la [[Mesosfera\|Mesosfera]]. È la fascia più esterna dell'atmosfera costituita principalmente da idrogeno e ioni prodotti dalla radiazione a bassa lunghezza d'onda.
...
![Schermata 2024-03-17 alle 22.00.25.png](/img/user/Universit%C3%A0/Triennale/3%C2%B0%20Anno/2%C2%B0%20Semestre/Idrologia/Appunti/allegati/allegati/Schermata%202024-03-17%20alle%2022.00.25.png)
...
La pressione, anche in una data quota, varia nello spazio e nel tempo. Si definisce pertanto una [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Superficie isobarica\|#Superficie isobarica]].
...
L'**isobara** è una linea, intersezione di una [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Superficie isobarica\|#Superficie isobarica]] con una altitudine assegnata.
...
Se si indica con $P_{d}$ la pressione dell'aria secca, la [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Pressione atmosferica\|#Pressione atmosferica]] $p$ è data da:
$$
p = P_{d} + \tau
$$
...
L'**umidità assoluta** è la densità del [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Vapor d'acqua\|#Vapor d'acqua]] nell'atmosfera.
```
...
La **tensione di saturazione** è la [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Tensione del vapor d'acqua\|#Tensione del vapor d'acqua]] quando si guarda ad un [[#Volume d'aria saturo]].
...
Quando la temperatura scende sotto il punto di rugiada si ha la condensazione del vapor d'acqua in eccesso, in modo da riportare l'[[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Umidità assoluta\|#Umidità assoluta]] a quella di saturazione con la nuova temperatura.
...
L'**umidità relativa** è il rapporto tra la [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Tensione del vapor d'acqua\|#Tensione del vapor d'acqua]] di un volume d'aria e la [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Tensione di saturazione\|#Tensione di saturazione]] dello stesso volume d'aria.
$
u = \frac{\tau}{\tau_{s}}
$
...
Nella [[Troposfera\|Troposfera]] il [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Gradiente termico verticale\|#Gradiente termico verticale]] è generalmente positivo (la temperatura diminuisce all'aumentare della quota).
...
Il gradiente adiabatico secco è il decremento della temperatura per unità di altitudine ([[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Gradiente termico verticale\|#Gradiente termico verticale]]) che l'aria subisce innalzandosi adiabaticamente, senza che abbia luogo la condensazione.
...
Il **gradiente adiabatico umido** è il decremento della temperatura per unità di altitudine ([[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Gradiente termico verticale\|#Gradiente termico verticale]]) che l'aria subisce innalzandosi adiabaticamente, quando il processo è accompagnato dalla condensazione del vapor d'acqua.
...
L'atmosfera si dice **assolutamente stabile** se il [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Gradiente termico verticale\|#Gradiente termico verticale]] $\gamma$ è minore (anche, quindi, se si è in presenza di un'[[#inversione]]) sia di $\Gamma_{s}$ sia di $\Gamma_{u}$.
...
L'atmosfera si dice **condizionatamente stabile** se il [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Gradiente termico verticale\|#Gradiente termico verticale]] $\gamma$ è minore di $\Gamma_{s}$ ma **NON** di $\Gamma_{u}$.
...
L'atmosfera si dice **assolutamente instabile** se il [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Gradiente termico verticale\|#Gradiente termico verticale]] $\gamma$ è maggiore sia di $\Gamma_{s}$, sia di $\Gamma_{u}$.
...
$
dove:
- $p:$ [[Università/Triennale/3° Anno/2° Semestre/Idrologia/Appunti/01 - Atmosfera#Pressione atmosferica\|#Pressione atmosferica]] ad una certa quota
