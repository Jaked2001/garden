---
{"dg-publish":true,"permalink":"/universita/triennale/2-anno/2-semestre/analisi-numerica/appunti/05-equazioni-differenziali-ordinarie/","dg-note-properties":{"aliases":["5. Soluzione numerica di equazioni differenziali ordinarie","Soluzione numerica di equazioni differenziali ordinarie"],"Materia":"ANEP","Tipo":"T","Stato":"🪶 Scrivere","Libro":"9"}}
---
...
Si definisce il [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Problema di Cauchy\|#Problema di Cauchy]] in un intervallo:
...
- Il [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Problema di Cauchy\|#Problema di Cauchy]] è [[#benposto]]
...
Metodi per la risoluzione di [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Problema di Cauchy\|#Problema di Cauchy]] che sfruttano un algoritmo nella forma:
$$
\begin{cases}
...
Il [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Metodo di Eulero\|#Metodo di Eulero]] ha **ordine di convergenza** pari a 1:
$$
p = 1
$$
```
...
Il [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Metodo di Heun\|#Metodo di Heun]] ha **ordine di convergenza** pari a 2:
$
p = 2
$
```
...
Il [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Metodo di Runge-Kutta\|#Metodo di Runge-Kutta]] ha **ordine di convergenza** pari a 4:
$
p = 4
$
```
...
**Allora**
Esiste un'**unica** soluzione al [[Università/Triennale/2° anno/2° Semestre/Analisi Numerica/Appunti/05. Equazioni Differenziali Ordinarie#Problema ai limiti\|#Problema ai limiti]]
```
