---
{"dg-publish":true,"permalink":"/universita/triennale/2-anno/2-semestre/probabilita-e-statistica/appunti/03-variabili-aleatorie/","dg-note-properties":{"aliases":["3. Variabili Aleatorie","Variabili Aleatorie"],"Materia":"PS","Tipo":"T","Stato":"🟢 Fatto"}}
---
...
si definiranno:
- $r = 1$: Primo momento (coincide con la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Media\|#Media]])
- $r = 2$: Secondo momento
...
La **deviazione standard** è ottenuta calcolando la radice quadrata della [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]
...
Sia $X \sim \mathrm{Bin}(n,p)$ con $n \in \mathbb{N}, \quad p \in [0,1]$
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Binomiale\|#Variabile Aleatoria Binomiale]] è:
$
\mathrm{Var}(X) = np(1-p)
$
```
...
È  un caso particolare di [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Binomiale\|#Variabile Aleatoria Binomiale]] in cui $n = 1$
...
La [[#Media di variabili aleatorie Discrete]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria di Bernoulli\|#Variabile Aleatoria di Bernoulli]] è:
$
EX = p
$
```
...
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria di Bernoulli\|#Variabile Aleatoria di Bernoulli]] è:
$
\mathrm{Var}(X) = p(1-p)
$
```
...
La [[#Media di variabili aleatorie Discrete]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Geometrica\|#Variabile Aleatoria Geometrica]] è: 
$
EX = \frac{1}{p}
$
___
...
Sia $X \sim \mathrm{Geo}(p)$ con $p \in [0,1]$
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Geometrica\|#Variabile Aleatoria Geometrica]] è: 
$
...
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria di Poisson\|#Variabile Aleatoria di Poisson]] è: 
$
\mathrm{Var}(X) = \lambda
$
...
La [[#Media di variabili aleatorie Continue]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile aleatoria Uniforme\|#Variabile aleatoria Uniforme]] è: 
$
...
Sia $X \sim \mathrm{Unif}(a,b)$ con $a,b \in \mathbb{R}$
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile aleatoria Uniforme\|#Variabile aleatoria Uniforme]] è: 
$
...
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Densità continua\|#Densità continua]] è
...
La [[#Media di variabili aleatorie Continue]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Esponenziale\|#Variabile Aleatoria Esponenziale]] è: 
$
...
Sia $X \sim \mathrm{Exp}(\lambda)$ con $\lambda > 0$
La [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Varianza\|#Varianza]]  per la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Esponenziale\|#Variabile Aleatoria Esponenziale]] è: 
$
...
> La Variabile Normale si ritrova in moltissime applicazioni pratiche. È stata introdotta inizialmente come approssimazione di una [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Binomiale\|#Variabile Aleatoria Binomiale]] per grandi valori del parametro $n$.
...
\end{align}
$$
dove $\Gamma\left( \frac{1}{2} \right) = \sqrt(\pi)$ per le **proprietà** della [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Funzione Gamma\|#Funzione Gamma]]. Per cui
$$
\begin{align}
...
È data una [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#3. Variabili Aleatorie\|variabile aleatoria]] $X \sim f_{X}(x)$. 
Si ha inoltre che 
$$
Y = g(X)
$$
Vogliamo caratterizzare $Y$, ossia trovarne la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Densità continua\|#Densità continua]] o densità discreta.
...
Per cui la [[Università/Triennale/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Densità continua\|#Densità continua]] è data da
$
\begin{align}
