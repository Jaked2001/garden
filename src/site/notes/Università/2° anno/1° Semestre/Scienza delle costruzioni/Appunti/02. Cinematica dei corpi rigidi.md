...
v = v_{o} + \theta x
\end{cases}
$$impongo $u = v = 0$ vedo che esiste sempre un punto che rimane fermo: $$x = -\frac{v_{o}}{\theta}, \,\,\, y = \frac{u_{o}}{\theta}$$Questo significa che ogni rototraslazione è una rotazione rigida. 
