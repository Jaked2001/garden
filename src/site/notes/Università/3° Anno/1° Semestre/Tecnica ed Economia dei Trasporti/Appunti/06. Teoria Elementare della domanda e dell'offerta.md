...
La domanda è la mobilità. L'offerta sono i servizi di trasporto che mettiamo a disposizione
...
Si fa quindi un macro-modello pseudo-razionale, e si mettono dentro tutti quelli che dovrebbero essere i fattori che influenzano. Viene lasciato un fattore di **residuo aleatorio**.
$$
...
Per utente razionale si intende quello che massimizza la propria soddisfazione.
...
- A: Il numero di spostamenti dipende dal tipo di spostamenti.
	- Ci sono degli spostamenti che si fanno comunque in numero limitato. (es. per andare a lavoro faccio gli stessi spostamenti, al di la di quanto guadagno)
...
La curva tende a spostarsi, traslando da una parte o dall'altra
...
Traslazione in **positivo** della curva di domanda aggregata dovuto ad esempio a:
- Aumento del reddito
...
Traslazione in **negativo** della curva di domanda aggregata dovuto ad esempio a:
- Diminuzione reddito
