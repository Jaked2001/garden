...
Siccome il $\rm Cr^{+6}$ in quanto ossidante è un accettore di elettroni...???
Aggiungo riducente - specie titolante - (solitamente Ferroammonio Solfato - $\rm Fe^{+2}$) per portare tutto il $\rm Cr^{+6}$ a $\rm Cr^{+3}$. Generalmente, quando faccio una titolazione, si fa all'equivalenza. Voglio portare tutto il cromo a ridursi.
$$
\begin{align}
...
\end{align}
$$
- [?] In che modo gli elettroni equive
- lenti sono legati al COD? 
