...
La robustezza è la proprietà di un indice statistico di resistere alla presenza di un [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Outlier\|#Outlier]].

```ad-Definizione
title: Robustezza

La robustezza di una grandezza è la sua capacità di resistere alla presenza di [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Outlier\|#Outlier]].
...
Il centro può essere scelto in vari modi, ognuno dei quali, vedremo, ha dei pro e dei contro. Iniziamo a vedere alcuni indici statistici che possiamo pensare di usare come [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Centro\|#Centro]] di una misura:
- [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Media aritmetica\|#Media aritmetica]]
- [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Mediana\|#Mediana]]
...
Stiamo implicitamente valutando la dispersione intorno al [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Centro\|#Centro]].

Esistono vari indicatori di dispersione, tra cui:
- [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Varianza\|#Varianza]]
	- [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Deviazione Standard\|#Deviazione Standard]]
- [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#MAD (Median Absolute Deviation)\|#MAD (Median Absolute Deviation)]]
- ...
...
La varianza è [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Robustezza\|poco robusta]] essendo definita rispetto la [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Media aritmetica\|#Media aritmetica]] che è, come detto, a sua volta poco robusta.
#### Deviazione Standard
...
N.MAD = 1.48 MAD
$$
Qualora $N.MAD = \sigma$ possiamo affermare che la distribuzione di probabilità dei miei valori è assimilabile a una [[Università/2° anno/2° Semestre/Probabilità e statistica/Appunti/03. Variabili Aleatorie#Variabile Aleatoria Normale o Gaussiana\|distribuzione normale (o Gaussiana)]].
...
Il minimo e il massimo di una distribuzione rappresentano la [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Dispersione\|#Dispersione]] come l'intervallo nel quale sono contenuti tutti i valori.
$$
{\rm MinMax} = x_{MAX} - x_{min}
$$
Non è affatto un indice [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Robustezza\|robusto]].

Questo indicatore è utile per ricordare il [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Teorema di Cebicev\|#Teorema di Cebicev]]
...
È data una [[Università/2° anno/2° Semestre/Probabilità e statistica/Appunti/01. Osservazione e probabilità#Variabili aleatorie\|variabile aleatoria]] $X$ di $n$-dimensioni
...
Usiamo il teorema della media per passare da ciò che misuriamo a ciò che calcoliamo. Il Teo. della Media può essere usato solamente se scegliamo la [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Media aritmetica\|#Media aritmetica]] come [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Centro\|#Centro]] della misura.

Rappresento la variabile di misura con una [[Università/2° anno/2° Semestre/Probabilità e statistica/Appunti/01. Osservazione e probabilità#Variabili aleatorie\|variabile aleatoria]] (v.a.)

- $x:$ Misura - Variabile della quale conosco il [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Centro\|#Centro]]
- $y:$ Risultato - Variabile della quale voglio determinare il [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Centro\|#Centro]] - Variabile **obiettivo**
So che posso definire $y$ come una qualche funzione $g$ di $x$:
$$
y = g(x)
$$

Siamo interessati a un [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Corollario al Teo della Media\|#Corollario al Teo della Media]]:
...
Date le [[Università/2° anno/2° Semestre/Probabilità e statistica/Appunti/01. Osservazione e probabilità#Variabili aleatorie\|variabili aleatorie]]:
- $X$ - $n$-dimensioni
- $Y$ - $m$-dimensioni

Siano rispettivamente
- $\mu_{X}:$ la [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Media aritmetica\|#Media aritmetica]] di $X$
...
- Rappresento il [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Centro\|#Centro]] di $b$ e $h$ usando la [[#Media aritmetica]]
...
Considerata la [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Matrice di covarianza\|#Matrice di covarianza]] $C_{XX}$:
$$
\underset{(n,n)}{C_{XX}} =
\begin{bmatrix}
\sigma_{x_{1}}^{2} & \sigma_{x_{1},x_{2}} & \dots & \sigma_{x_{1},x_{n}} \\
...
Per la **legge di propagazione della covarianza**, se sono rispettate le stesse ipotesi del [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Corollario al Teo della Media\|#Corollario al Teo della Media]], si ha che:
$$
...
Si immagini di avere le seguenti quantità con le rispettive [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Media aritmetica\|medie]]:
- $\alpha:$ [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#\|##direzione azimutale]] $\longrightarrow \mu_\alpha$
- $z:$ [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#\|##angolo zenitale]] $\longrightarrow \mu_{z}$
- $d:$ distanza $\longrightarrow \mu_{d}$

A queste misure corrisponde una [[Università/3° Anno/2° Semestre/Topografia e Positioning/Appunti/03 - Statistica in Topografia - TP#Matrice di covarianza\|#Matrice di covarianza]] $C_{\alpha z d,\alpha z d}$
Si avrà quindi
$$
X =
\begin{bmatrix}
